...
console.log(`Q4: Is Marks BMI higher than John's? WHy yes, it's ${markMoreBeefCake}, it is`);
...
if(markBMI > johnBMI) console.log(`Q5:Mark (${markBMI.toFixed(2)}) `);
else console.log(`Q5: John ${johnBMI.toFixed(2)}`);